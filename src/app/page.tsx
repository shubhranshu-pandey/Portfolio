    ...
    <div className="relative min-h-screen">
      ...
      <TracingBeam>
        <main className="flex flex-col min-h-[100dvh] space-y-10 relative z-10">
          ...
          <section id="summer-training" className="transform-gpu">
            <div className="flex min-h-0 flex-col gap-y-3">
              <BlurFade delay={BLUR_FADE_DELAY * 7.5}>
                <h2 className="text-xl font-bold">Summer Training</h2>
              </BlurFade>
              {DATA.summerTraining.map((training, id) => (
                <BlurFade
              ...
              <BlurFade delay={BLUR_FADE_DELAY * 16}>
                <div className="space-y-3">
                  ...
                  <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Want to chat? Just reach out to me via{" "}
                    <Link
