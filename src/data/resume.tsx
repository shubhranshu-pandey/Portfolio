...
export const DATA = {
  ...
  navbar: [
    ...
    { href: "https://drive.google.com/file/d/1C3xHBi6U2XfJFpQxyFGQiZsZbW8SVHc2/view?usp=share_link", icon: FileTextIcon, label: "CV", target: "_blank" },
  ],
  contact: {
  ...
  work: [
    {
      ...
      badges: [],
      location: "Remote",
      title: "Associate Software Engineer Intern - DevOps",
      logoUrl: "/mphasislogo.png",
      start: "Dec 2025",
      end: "Apr 2026",
      description:
        "Worked as a DevOps Intern at Mphasis, gaining hands-on experience in cloud infrastructure, CI/CD automation, and containerized deployments. Built and managed CI/CD pipelines using Azure DevOps to automate build and deployment workflows, deployed applications on Azure App Service, and worked with Docker for application containerization across environments. Trained and worked on industry-standard DevOps tools including Linux, Jenkins, Git, Terraform, Nagios, and SonarQube to improve deployment efficiency, monitoring, and system reliability while collaborating with development teams in agile workflows.",
    },
    {
      company: "Outlier AI",
